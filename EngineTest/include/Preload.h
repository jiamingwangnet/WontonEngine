...
void preload(won::Game& game)
{
	...
	datalist.push_back(won::UniformData<float>::GenData("smoothness", won::UniformType::Float, 32.0f));
	...
	datalist2.push_back(won::UniformData<float>::GenData("smoothness", won::UniformType::Float, 0.0f));
